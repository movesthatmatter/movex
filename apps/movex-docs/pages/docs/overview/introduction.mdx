...
1. [Authoritative Server w/o Server Code](/docs/features/server_authoritative)
2. [Realtime State Sync](/docs/features/realtime)
3. [Secret State](/docs/features/secret_state)
4. [Easy, functional way to handle the state via Actions & Reducers](/docs/features/functional)