...
> implements EventEmitter<IOEvents<TState, TAction, TResourceType>>
{
  ...
  // TODO: Aici am ramas ieri. Efectir in a seta backendul + clientul pe socket, Iar apoi sa creez an application (server and client) to demo it.
  //  I'm thinking of a voting app using moves so I can showcase the server authoritative model
  ...
  constructor(
    ...
    this.socketInstance = new SocketServer(httpServer, {
      cors: {
        origin: '*',
      },
    });
