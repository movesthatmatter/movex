...
// import { ActionsCollectionMapBase, AnyAction, ToCheckedAction } from './tools/action';
// import { MovexReducer } from './tools/reducer';
// import { MovexClientResource } from './MovexClientResource';
// import { MasterResourceConnection } from './MasterResourceConnection';
...
//   constructor(private socketInstance: Socket, private config: MovexConfig) {
...
//   private masterResourcesByType?: Record<string, MovexReducer>;

//   newConstructor(
//     masterResourcesByType: Record<string, MovexReducer>
//   ) {
//     this.masterResourcesByType = masterResourcesByType;
//   }

//   // OR use generic if not working
//   newCreateResource(type: keyof typeof this.masterResourcesByType) {
//     /// The creatoin of the resource should be here based on the type of the movex reducers

    
//   }

//   registerResourceReducer<S, A extends AnyAction>(
//     rid: ResourceIdentifier<string>,
//     reducer: MovexReducer<S, A>
//   ) {
//     // const masterResourceIO = new MasterResourceIO(reducer);

//     // const fakeMasterIo = {} as MasterResourceIO<A>;
//     const fakeMasterConnection = {} as MovexIOMasterConnection;
//     const masterResourceConnection = new MasterResourceConnection(
//       fakeMasterConnection,
//       reducer
//     );
...
//     fakeMasterConnection.onMessage((msg) => {
//       if (msg.kind === 'fwdAction') {
//         clientResource.reconciliateAction(msg.payload.action as ToCheckedAction<A>);
//       }
//     });
...
// export const createMovexInstance = (config: MovexConfig, ioClient?: Socket) => {
...
//   return new Movex(socket, config);
// };
